...
import numpy as np
from src.nnunet.paths import network_training_output_dir
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", '--input_folder',
                        default="/home/ictpercomp/sdb1/chengs18/nnunet_dataset_torch/nnUNet_raw/nnUNet_val_data/predict",
                        help="Must contain all modalities for each patient in the correct", required=False)
    parser.add_argument('-o', "--output_folder",
                        default="/home/ictpercomp/sdb1/chengs18/nnunet_dataset_test/nnUNet_raw/nnUNet_raw_data/Task040_KiTS",
    ...
    json_dict['numTest'] = 0
    json_dict['training'] = [{'image': "./imagesTr/%s.nii.gz" % i.split('.')[0], "label": "./labelsTr/%s.nii.gz" % i.split('.')[0]} for i in
                             cases]
    json_dict['test'] = []
