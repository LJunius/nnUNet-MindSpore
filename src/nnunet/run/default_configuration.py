...
import src.nnunet
from src.nnunet.experiment_planning.summarize_plans import summarize_plans
from src.nnunet.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    if network in ('3d_cascade_fullres', "3d_lowres") and len(possible_stages) == 1:
